...
class DOB4Details extends StatefulWidget {
  const DOB4Details({super.key});
  @override
  State<DOB4Details> createState() => _DOB4DetailsState();
}

class _DOB4DetailsState extends State<DOB4Details> {
  bool isExpand = false;
  @override
  void initState() {
    super.initState();
