...
class DOB5Details extends StatefulWidget {
  const DOB5Details({super.key});
  @override
  State<DOB5Details> createState() => _DOB5DetailsState();
}

class _DOB5DetailsState extends State<DOB5Details> {
  bool isExpand = false;
  @override
  void initState() {
    super.initState();
